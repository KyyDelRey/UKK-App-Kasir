...
<body>
    ...
    <form class="mx-auto max-w-md" method="POST" action="{{ route('user.store') }}">
        @csrf
        ...
        <div class="group relative z-0 mb-5 w-full">
            ...
            <label for="name"
                class="absolute top-3 -z-10 origin-[0] -translate-y-6 scale-75 transform text-sm text-gray-500 duration-300 peer-placeholder-shown:translate-y-0 peer-placeholder-shown:scale-100 peer-focus:start-0 peer-focus:-translate-y-6 peer-focus:scale-75 peer-focus:font-medium peer-focus:text-blue-600 rtl:peer-focus:left-auto rtl:peer-focus:translate-x-1/4 dark:text-gray-400 peer-focus:dark:text-blue-500">Nama</label>
        </div>
        <div class="group relative z-0 mb-5 w-full">
        ...
        <div class="group relative z-0 mb-5 w-full">
            ...
            <select id="level" name="level" :value="old('level')" required autofocus autocomplete="level"   class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
