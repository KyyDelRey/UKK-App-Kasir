    ...
    <body>
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
            ...
            <a href="{{ route('penjualan.create') }}"
                class="font-medium text-gray-600 hover:underline dark:text-gray-500">Proses Penjualan</a>
            <a href="{{ route('penjualan.index') }}"
                class="font-medium text-yellow-600 hover:underline dark:text-yellow-500">Kembali</a>
        </div>
    </body>
